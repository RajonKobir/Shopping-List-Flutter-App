...
An useful shopping list Flutter app including CRUD operations on items. Firebase firestore has been used as a backend database.
...
- Rename the project folder to 'shopping_list', or you can change the name later.
